function [ sStatsTest ] = statsf_paired2sampleTestsStatsStruct_cndtn( dataVec, cndtnVec )
%
...
% statistical test
sStatsTest.TTest1 = stats_BuildStructTTest1(data1, data2);
sStatsTest.SignRank = stats_BuildStructSignRank(data1, data2);
